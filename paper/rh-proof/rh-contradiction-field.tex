...
Assume Seed-Transfer, Baseline-Subtraction, the three internal potentials for $A,FCT,SC$, the $PI/DSO$ capacity ledger, the $LV/LSMP/CE$ absorbing thresholds, and the $NRC$ routing alternatives.  Then the GEE event graph has no infinite directed cycle carrying positive final load.
\end{lemma}
\begin{proof}[Review proof]
