...
- `docs/rh-dso-capacity-final-audit.md`：DSO/容量定理最终审稿矩阵。
- `docs/rh-lsmp-fct-capacity-final-audit.md`：LSMP/FCT/CapacityFail 最终闭合强度审稿。
...
- `docs/rh-pc4-fct-noether-descent-ledger.md`：PC4-FCT Noether 离散下降量账本与防循环审查。
...
- `docs/rh-pc4-external-event-absorption-audit.md`：PC4 LV/LSMP/NRC/CE/DSO/CapacityFail 外部事件吸收总审查。
...
- `docs/rh-pc2-crt-baseline-maintext-appendix.md`：PC2 CRT 基线、候选账本与边界误差主文证明附录。
