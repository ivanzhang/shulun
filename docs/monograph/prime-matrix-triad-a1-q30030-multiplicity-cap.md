...
| 17 | `[]` | 28 | 28 | 1 |
| 19 | `[17]` | 496 | 368 | 17 |
| 23 | `[17, 19]` | 3456 | 936 | 35 |
| 29 | `[17, 19, 23]` | 6416 | 610 | 112 |

## 4. 升级容量行

| row_id | block | phase count | bound | all M=0 | pass |
| --- | --- | ---: | ---: | --- | --- |
| `CC-LHB-WHOLEDEF-MULT-Q30030-P17` | `whole_deficit_phases` | 30002 | 0 | `True` | `True` |
| `CC-LHB-BRIDGED-MULT-Q30030-P17` | `bridged_critical_phases` | 0 | 0 | `True` | `True` |
| `CC-LHB-WHOLEDEF-MULT-Q30030-P19` | `whole_deficit_phases` | 29662 | 0 | `True` | `True` |
| `CC-LHB-BRIDGED-MULT-Q30030-P19` | `bridged_critical_phases` | 0 | 0 | `True` | `True` |
| `CC-LHB-WHOLEDEF-MULT-Q30030-P23` | `whole_deficit_phases` | 29094 | 0 | `True` | `True` |
| `CC-LHB-BRIDGED-MULT-Q30030-P23` | `bridged_critical_phases` | 0 | 0 | `True` | `True` |
| `CC-LHB-WHOLEDEF-MULT-Q30030-P29` | `whole_deficit_phases` | 29420 | 0 | `True` | `True` |
| `CC-LHB-BRIDGED-MULT-Q30030-P29` | `bridged_critical_phases` | 0 | 0 | `True` | `True` |
