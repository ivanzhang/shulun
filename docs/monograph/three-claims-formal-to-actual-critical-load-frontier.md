...
### Phi-LPF q-prefix pure endpoint phase-interface formal-to-actual 更新
...
本层删除的是“pure endpoint 能整体套外部 trace 定理”的黑箱；没有删除 single-`P`
局部包估计、multi-`P` completion 或实际相消缺口。FKMS、Milićević--Qin--Wu
...
### Phi-LPF q-prefix single-P local gap2/gap4 top-two core largest-atom dominant sign-word path formal-to-actual 更新
...
### Phi-LPF repeated-step packet-enclosure terminal phase-normal-form formal-to-actual 更新
