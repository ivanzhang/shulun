...
| --- | --- | --- | --- | --- |
| `PDECCapRequestsAPS` | `true` | `false` | SameSetPDECDualComparisonForPersistentMFU_OR_DenseOldHoleKernelOrSC9 | 上一层 PDEC-CAP 前沿已经把 APS 投影塔二分定位为当前门，或已越过 APS 推进到两侧终端估计。 |
