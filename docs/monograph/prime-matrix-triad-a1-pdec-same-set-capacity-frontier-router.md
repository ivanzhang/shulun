...
DI/BFI 定理位置已固定为 BFI Theorem 10 与 DI Theorem 12；generic WFD 外部引用版只剩 AP->KE13 对象不变转移和 dyadic 尺度不等式；完全自足版仍未证明原始 dispersion。
