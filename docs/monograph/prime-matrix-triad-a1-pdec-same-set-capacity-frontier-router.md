...
DI/BFI 定理位置已固定为 BFI Theorem 10 与 DI Theorem 12；generic WFD 外部引用版只剩当前窗口假设匹配，完全自足版仍未证明原始 dispersion。
