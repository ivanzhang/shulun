...
DI/BFI 定理位置已固定为 BFI Theorem 10 与 DI Theorem 12；AP-source 直接 BFI 分支已闭合；非 AP generic WFD 外部引用版剩未中心化无投影恒等式与 DI Kloosterman 窗口代入账本；APSourceLift 已被当前合同排除；完全自足/主来源逐项版仍只剩 FullSNonAPStrengthenedSourceAntiAtomContractOrExternalDIBFIKuznetsov。
