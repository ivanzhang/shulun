...
DI/BFI 定理位置已固定为 BFI Theorem 10 与 DI Theorem 12；AP-source 直接 BFI 分支已闭合；非 AP generic WFD 外部引用版剩原始 dispersion 定理假设匹配；完全自足版仍未证明原始 dispersion。
