...
**状态：** `same_set_capacity_frontier_materialized_quantified_no_projection_open`
...
DI/BFI 定理位置已固定为 BFI Theorem 10 与 DI Theorem 12；generic WFD 外部引用版只剩无投影对象恒等式与 DI/BFI 量化窗口代入证书；完全自足版仍未证明原始 dispersion。
