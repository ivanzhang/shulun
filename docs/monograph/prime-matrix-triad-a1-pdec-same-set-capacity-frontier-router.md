...
generic WFD 外部引用版已压成 DI/BFI 原文定理位置与假设匹配；完全自足版仍未证明 generic noncanonical WFD 原始 dispersion。
