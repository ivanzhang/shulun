...
这些入口已分别由 `docs/rh-pc4-terminal-final-no-cycle-audit.md`、`docs/rh-pc4-external-event-absorption-audit.md` 与 `docs/rh-pc4-dual-dgap-event-match-audit.md` 接收；DGap 的投影、低维抽取、DSO/PI 桥接和 FCT_seed 同型细节由 `docs/rh-dgap-projection-line-by-line-audit.md`、`docs/rh-dgap-lowdim-extraction-line-by-line-audit.md`、`docs/rh-dso-pi-squarefunction-bridge-audit.md`、`docs/rh-fct-seed-isomorphism-audit.md` 补强。
