...
- `docs/rh-ov2-phase-pushforward-interface.md` / `docs/rh-ov2-ppi-unconditional-theorem.md`：PPI，相位推送接口及无条件核心；
- `docs/rh-ov2-main-layer-capacity-interface.md` / `docs/rh-ov2-mlc-unconditional-core.md`：MLC，主层容量接口及无条件容量核心；
