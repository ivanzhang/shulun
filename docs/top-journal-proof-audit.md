...
1. `Tail-log4` 三项已在 `docs/tail-log4-theoremization.md` 拆成 TL4-L/TL4-S/TL4-M；引用匹配见 `docs/rks-log-reference-audit.md` 与 `docs/rks-bridge-partition.md`。近极端块已可由 Weil 吸收，下一步主要做 RKS-parameter-audit。
