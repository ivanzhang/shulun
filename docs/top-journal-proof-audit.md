...
1. `Tail-log4` 三项已在 `docs/tail-log4-theoremization.md` 拆成 TL4-L/TL4-S/TL4-M；引用匹配见 `docs/rks-log-reference-audit.md`。下一步主要是补 RKS-bridge，处理 BG 定理未直接覆盖的近临界 Type I/II 块。
