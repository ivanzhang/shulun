...
- 互补因子素性阈值失败次数：`5`。
- 最后一个阈值失败 p：`19`。
- floor offset 分布：`{'1': 2382774, '2': 1224068, '3': 163279}`。
- 单行最多互补因子记录：`{'p': 98327, 'y': 36172, 'tail_prime_count': 5602, 'yrough_cofactors': 817, 'offset_counts': {2: 267, 3: 42, 1: 508}}`。
