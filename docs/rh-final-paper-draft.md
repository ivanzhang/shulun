...
1. 将 `docs/rh-pc1-explicit-formula-proof-appendix.md` 合并入主文，并给 `EXT-PC1-LI` 补精确书目、章节或定理号；
...
7. 完成所有外部定理 `EXT-KL/BG/Vaaler/Selberg/Vaughan/PC1` 的精确引用；
