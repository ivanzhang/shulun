...
Dense-scale orthogonality 已在 `docs/rh-pc4-dense-scale-orthogonality.md` 中拆成 DSO-M、DSO-C、DSO-E 三个接口。下一步最优专攻是 DSO-C：构造 inverse-limit CRT martingale square function。
