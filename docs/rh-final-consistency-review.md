...
10. LSMP/FCT/CapacityFail：`docs/rh-lsmp-fct-capacity-final-audit.md`，并由 `docs/rh-capacityfail-binding-table.md` 与 `docs/rh-capacity-constants-applicability-audit.md` 统一核验容量绑定、适用条件和常数余量；全局对数常数层级见 `docs/rh-global-log-constant-hierarchy-audit.md`。
