...
6. PC4-Dual/DGap：`docs/rh-pc4-dual-dgap-event-match-audit.md`，并由 `docs/rh-dgap-projection-line-by-line-audit.md`、`docs/rh-dgap-lowdim-extraction-line-by-line-audit.md`、`docs/rh-dso-pi-squarefunction-bridge-audit.md` 与 `docs/rh-fct-seed-isomorphism-audit.md` 补强投影、低维抽取、DSO/PI 桥接和 FCT_seed 同型接口；
