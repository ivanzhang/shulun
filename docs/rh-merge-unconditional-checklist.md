...
| C5 | 过密 Dual/DGap | `docs/rh-c5-dgap-inline-proof-chain.md` | Lemma C5.1--C5.4 已定理化；剩余依赖 C2/C6/C9/C10 | 内部已闭合，待依赖放电 |
...
| C8 | `CapacityFail` | `docs/rh-c8-capacityfail-upgrade-audit.md` | 自由黑箱已排除；C5 已定理化，剩余随 C4/C6/C9/C10 的容量定理化放电 | 依赖型待闭合 |
...
2. C8 已从自由黑箱降级为依赖型义务；C5 已定理化，最终随 C4/C6/C9/C10 放电。
3. C5 已补为 DGap 三接口编号证明链；下一步优先补 C6 内部终端或 C9 尾项内联。
