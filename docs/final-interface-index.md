...
| C Tail-log4 | `docs/tail-log4-theoremization.md`, `docs/rks-log-reference-audit.md`, `docs/rks-bridge-partition.md`, `docs/rks-parameter-audit.md` | 已拆成 TL4-L/S/M | 最终引用文字与附录化 |
