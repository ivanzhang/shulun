...
def run(
    ...
    return {
        ...
        "structural_law": (
            ...
            "当前无黑箱版只剩 A1CleanBranchCanonicalSourceAdmission，"
        ...
        "review_conclusion": (
            ...
            "下一步不再是普通计数、保留率常数、无抵消、决策树、谱估计或源头锁定语义，"
            "而是证明当前被攻击的 clean A1 分支确实准入 canonical RIW/Buchstab source branch；"
            "否则必须走外部 DI/BFI 或回 PDEC/SAE。"
